...
export const createCardPopupTemplate = (data) => {
  const {poster, name, rating, releaseDate, runtime, genres, description, old, director, writers, actors, country, comments, isFavorite, isWatched, isInWatchlist} = data;
